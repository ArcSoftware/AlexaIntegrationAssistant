...
```
    cd "AlexaIntegrationAssistant"
    dotnet restore
```

Execute unit tests
```
    cd "AlexaIntegrationAssistant/test/AlexaIntegrationAssistant.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "AlexaIntegrationAssistant/src/AlexaIntegrationAssistant"
